...
from users.models import Alumni, Mentor, Profile
from website.models import Achievement, Archive, Event, Gallery
...
def member(request):
    ...
    return render(
        request, template_name="website/member.html", context={"members": members}
    )
...
def mentor(request):
    ...
    return render(
        request, template_name="website/mentor.html", context={"mentors": mentors}
    )
...
def alumni(request):
    ...
    return render(
        request, template_name="website/alumni.html", context={"alumnus": alumnus}
    )
...
def event(request):
    ...
    return render(
        request, template_name="website/events.html", context={"events": events}
    )
...
def project(request):
    ...
    return render(
        request, template_name="website/projects.html", context={"projects": projects}
    )
...
def achievement(request):
    ...
    return render(
        request,
        template_name="website/achievement.html",
...
def archive(request):
    ...
    return render(
        request, template_name="website/archive.html", context={"archive": archive}
    )
...
def agenda(request):
    ...
    agendas = []
    return render(
        request, template_name="website/calendar.html", context={"agendas": agendas}
    )
